		...
		protected void configure(HttpSecurity http) throws Exception {
			http
				...
				.authorizeRequests()
					...
					.antMatchers("/admin/produtos/consoles/excluir/**").hasRole("EXCLUIR_PRODUTO")
					.antMatchers("/admin/produtos/controles/excluir/**").hasRole("EXCLUIR_PRODUTO")
					.antMatchers("/admin/produtos/jogos/excluir/**").hasRole("EXCLUIR_PRODUTO")
					.antMatchers("/admin/produtos/pesquisar").hasRole("CONSULTAR_PRODUTO")
					.antMatchers("/admin/usuarios/novo").hasRole("CADASTRAR_USUARIO")
					.antMatchers("/admin/usuarios/alterar/**").hasRole("ALTERAR_USUARIO")
					.antMatchers("/admin/usuarios/excluir/**").hasRole("EXCLUIR_USUARIO")
					.antMatchers("/admin/usuarios/pesquisar").hasRole("PESQUISAR_USUARIO")
